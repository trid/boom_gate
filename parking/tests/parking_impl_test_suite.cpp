...
TEST(ParkingImplTestSuite, carEnters) {
    ...
    ParkingImpl parking{std::move(paymentSystem), GateControlStrategyFactory::createPayOnGate(std::make_unique<BillingSystemMock>(), carsRegistry, billingListenerMock)};
